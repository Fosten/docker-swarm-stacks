...
- Change local stack_param for invoiceninja, snipe-it, ethercalc, sphinx, and stirlingpdf [fosten]
- Remove ALLOY_HOST_DOCKER_GID in Alloy stack [fosten]
- Change local stack_param for grafana, alloy, loki, mimir, tempo, and prometheus [fosten]
...
- Merge hermes-gateway and hermes-dashboard [fosten]
...
- Add Prometheus Node Exporter [fosten]
...
- Rename config.alloy, set alloy user, mountd data dir, and disable auth in loki [fosten]
- Configure single-node replication factors for Mimir stack [fosten]
- Add Alloy [fosten]
